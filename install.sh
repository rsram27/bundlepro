...
if [ -f "$INSTALL_PATH" ]; then
    ...
    echo -e "${YELLOW}========================================${NC}"
    echo ""
    echo "  1. Clone o repositorio de projetos (se ainda nao fez):"
    echo "     git clone git@github.com:BundlePro/bundlepro-agr-cti-databricks.git ~/bundlepro-agr-cti-databricks"
    echo ""
    echo "  2. Entre no diretorio:"
    echo "     cd ~/bundlepro-agr-cti-databricks"
    echo ""
